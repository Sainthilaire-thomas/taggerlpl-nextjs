// src/features/phase1-corpus/calls/domain/services/DiarizationService.ts
// Service de diarisation - VERSION RESTAURÉE avec provider
...
export class DiarizationService {
  constructor(private readonly provider: DiarizationProvider) {
    console.log("👥 DiarizationService initialized with provider");
  }

  /**
   * Infère les segments de diarisation depuis l'URL audio
   */
  async inferSegments(
    audioUrl: string,
    opts?: {
