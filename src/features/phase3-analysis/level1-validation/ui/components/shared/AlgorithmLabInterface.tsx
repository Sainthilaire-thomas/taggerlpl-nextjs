...
// import { algorithmRegistry } from "@/features/phase3-analysis/level1-validation/algorithms/shared/AlgorithmRegistry"; // Props pour l'int�gration dans la page analysis
...
export const AlgorithmLabInterface: React.FC<AlgorithmLabInterfaceProps> = ({
  ...
  // React.useEffect(() => {
  //   // Peupler le registre c�t� client si vide
    ...
    <Box sx={styles.mainContainer}>
          ...
          <Box sx={{ display: "flex", alignItems: "center", gap: 2, mb: 1 }}>
            ...
            <Box>
              ...
              <Typography variant="body1" color="text.secondary">
                Framework de validation scientifique � 3 niveaux - Int�gr� au
                Centre d'Analyse
              </Typography>
              {selectedOrigin && (
                <Typography
      ...
      <Paper elevation={1} sx={styles.footerPaper}>
        <Box sx={{ textAlign: "center" }}>
          ...
          >
            <strong>Validation s�quentielle :</strong> Gold Standard ?
            Performance Technique ? Hypoth�ses Scientifiques
          </Typography>
          <Box
            sx={{
              display: "grid",
...
// Export unique par d�faut pour l'int�gration
