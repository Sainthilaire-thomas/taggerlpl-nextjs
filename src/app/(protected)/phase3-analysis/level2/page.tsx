...
import { Box, Typography, Paper, Card, CardContent, CardActionArea, Chip, Alert, CircularProgress, Divider } from '@mui/material';
...
export default function Level2DashboardPage() {
  ...
  const m1Color: 'warning' | 'default' = stats.withM1 > 0 ? 'warning' : 'default';
